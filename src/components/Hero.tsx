  ...
  return (
    <>  
        <main className="max-w-full flex justify-between items-center pt-18">
            <div className='flex  flex-col gap-2 w-[560px] items-center'>
                ...
                <p className='text-lg mb-11'>Não importa quanto você ganha, com um bom planejamento e a <strong>ferramenta ideal</strong> é possível fazer sobrar dinheiro e investir no que realmente importa para você.</p>
                <Button1 href="#" className='btn1-mpf'>Quero ter tranquilidade financeira</Button1>
                <span className='block text-[12px] text-center'>Apenas R$ 16,50/mês (assinatura anual)</span>
            </div>
